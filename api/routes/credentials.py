...
from api.enums import Role, WebhookCredentialType
...
async def create_credential(
    ...
    """
    Create a new webhook credential. Org admins only.
...
async def delete_credential(
    ...
    """
    Delete (soft delete) a webhook credential. Org admins only.
