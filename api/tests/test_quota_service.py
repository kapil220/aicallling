...
# --- Local billing engine authorization ------------------------------------------

from unittest.mock import AsyncMock  # noqa: E402

from api.services.billing.pricing import RateResult  # noqa: E402
...
@pytest.mark.asyncio
async def test_local_authorize_accepts_and_stashes_rate(monkeypatch):
    from api.services import quota_service as qs
    ...
    assert kwargs["cost_info"]["price_per_minute_cents"] == 6000
    assert kwargs["cost_info"]["max_affordable_seconds"] == 42
