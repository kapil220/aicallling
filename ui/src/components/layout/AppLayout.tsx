...
function AppHeader() {
  ...
  // Slack community + GitHub-star upsells are OSS-only asks; saas tenants are
  // paying customers, not open-source contributors to court.
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between border-b border-border/60 bg-background/70 px-4 py-2 backdrop-blur-md supports-[backdrop-filter]:bg-background/55">
      <div className="flex items-center gap-3">
        ...
        <Link href="/" className="text-lg font-bold md:hidden">{BRAND_NAME}</Link>
      </div>
      {isOSSMode && (
        <div className="flex items-center gap-3">
